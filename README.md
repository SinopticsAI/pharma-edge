...
**Конвенции CI/CD:** [`SinopticsAI/yandex-cloud-functions`](https://github.com/SinopticsAI/yandex-cloud-functions) (Logos Edge). Этот репозиторий **не** делит квоту и биллинг с Logos. **Push и прогон CI/CD — только владелец репозитория, не агент** ([`spec/deploy.md`](spec/deploy.md)).

Волна 1 в репозитории: Cloud Functions в `scr/`. Канон PostgreSQL — [`SinopticsAI/pharma-postgracesql`](https://github.com/SinopticsAI/pharma-postgracesql), канон шлюза и DNS — [`SinopticsAI/pharma_env`](https://github.com/SinopticsAI/pharma_env). Первый подъём — базы, затем функции по [`infra/README.md`](infra/README.md), затем ingress оттуда.
...
| [`infra/README.md`](infra/README.md) | Локальные скрипты; ingress `pharma-edge.sinoptics.ru` — канон в [`pharma_env`](https://github.com/SinopticsAI/pharma_env) |
